...
static const struct q6dsp_clk_init q6prm_clks[] = {
	...
	Q6DSP_VOTE_CLK(LPASS_HW_DCODEC_VOTE, Q6PRM_HW_CORE_ID_DCODEC,
		       "LPASS_HW_DCODEC"),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF0_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF0_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF1_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF1_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF2_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF2_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF3_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF3_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF4_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF4_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF5_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF5_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF6_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF6_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF6_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF7_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF7_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF8_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF8_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF9_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF9_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF10_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF10_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF11_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF11_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF12_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_INTF12_EBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_VA_INTF0_IBIT),
    Q6PRM_CLK(QAIF_CLK_ID_AUD_VA_INTF0_EBIT),
};
